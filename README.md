...
This is the repository of Electric Exhibition System (EES) backend server. A system that can held virtual exhibition online as well as using as a handbook with physical exhibition.
...
2. Download all files from this repository and place in the PHP 5 server hosting folder.
