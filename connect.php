							...
							<li>
								 <div class="row">
										...
										<div class="bottom text-center">
											還沒有帳號嗎 ? <a href="register.php"><b>註冊帳號</b></a>
										</div>
								 </div>
							</li>
						</ul>
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					<?php
						...
						{
							$sql = "SELECT * FROM exhibition where organizer_id = '$row[0]'";
							$result = mysql_query($sql);
							$ex_row = @mysql_fetch_row($result);
							$sql = "SELECT * FROM booth where holderId = '$row[0]'";
							$result = mysql_query($sql);
							$h_row = @mysql_fetch_row($result);
						...
						?>
							<div id="dialog1" title="提示訊息" style="display:none;"><p>帳號或密碼錯誤，請重新輸入一次</p></div>
							<div id="dialog2" title="提示訊息" style="display:none;"><p>登入成功</p></div>
							<div id="dialog3" title="提示訊息" style="display:none;"><p>登入失敗，您非展覽負責人或攤位負責人，無權進入後台</p></div>
